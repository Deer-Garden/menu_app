...
# 利用方法
ユーザーが献立を投稿したり、献立が思いつかないときに投稿されている献立を見て気に入ったのを見つけることができます。投稿したユーザーは料理の記録ができ、お気に入りの数で人気度を図ることが出来ます。献立を探す際は、レシピのおすすめを見て、献立を考える手間を減らしたり、簡単に人気のある料理を見つけることが出来ます。
